...
# Absolute, not relative to whatever the process's cwd happens to be — on
# a serverless platform (Vercel et al.) the working directory when the
# function runs isn't guaranteed to be this file's own directory.
